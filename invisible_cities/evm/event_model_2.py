...
class Hit(Cluster):
    ...
    def __init__(self, peak_number, cluster, z, s2_energy, peak_xy, time, nS2):
    ...
    def __str__(self):
        return """<{} : npeak = {} z = {} XYpeak = {}, {}, time = {} nS2 = {}, E = {} cluster ={} >""".format(self.__class__.__name__,
                    self.npeak, self.Z, self.Xpeak, self.Ypeak, self.time, self.nS2,  self.E, super().__str__())
